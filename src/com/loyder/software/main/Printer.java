...
public final class Printer
{
     ...
     * Entry point.
     */
    public static void main(String args[]) throws PrinterException, IOException, ClassNotFoundException
    {
     ...
     */
    private static void printWithDialog(String filename) throws IOException, PrinterException
    {
        try (PDDocument document = PDDocument.load(new File(filename)))
        {
            PrinterJob job = PrinterJob.getPrinterJob();
